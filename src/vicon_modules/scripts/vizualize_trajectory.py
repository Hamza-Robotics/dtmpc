...
class Vizualize_Solution(Node):
    def __init__(self):
        super().__init__('vizualize_trajectory')
        self.publisher_path_1 = self.create_publisher(Path, 'dtmpc/trajectory/broadcast/'+'robot1'+'/viz', 10)
        self.publisher_path_2 = self.create_publisher(Path, 'dtmpc/trajectory/broadcast/'+'robot2'+'/viz', 10)
        self.publisher_path_3 = self.create_publisher(Path, 'dtmpc/trajectory/broadcast/'+'robot3'+'/viz', 10)
        ...
        self.PORT1 = int(str(1)*5)+1
        self.PORT2 = int(str(2)*5)+2
        self.PORT3 = int(str(3)*5)+3
    ...
    def timer_callback(self):
        try:
            ...
            self.solution_robot1 = np.hstack((self.solution_robot1, np.zeros((self.solution_robot1.shape[0], 1))))
